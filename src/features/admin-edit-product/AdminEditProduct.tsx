import { useGetAdminProductApi, useUpdateAdminProductApi } from "@/entities/product/api";
...
const AdminEditProduct = () => {
  ...
  const getAdminProductApi = useGetAdminProductApi();
  const updateAdminProductApi = useUpdateAdminProductApi();
  ...
  const mutation = useMutation({
    ...
    onSuccess: () => {
      dispatch(setModalContent({ header: "message", message: "Successfully editing product" }));
